...
public class CreateNewLeadByGivingValidNoOfEmployeeTest {

	@Test
	
	public void createNewLeadByGivingValidNoOfEmployeeTest() throws Throwable
	
	{
		//Step 1: Create Random numbers
				...
				String Company = cel1.getStringCellValue();
				 ...
				 double NoE = cel2 .getNumericCellValue();
