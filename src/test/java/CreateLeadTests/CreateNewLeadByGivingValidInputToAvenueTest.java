...
public class CreateNewLeadByGivingValidInputToAvenueTest {
	
	@Test
	
	public void createNewLeadByGivingValidInputToAvenueTest() throws Throwable
	{
		...
		String Company = cel1.getStringCellValue();
		 ...
		 double Avenue = cel2 .getNumericCellValue();
