...
public class CreateNewLeadByGivingInvalidInputToAnnualRevenueTest {

	@Test
	
	public void createNewLeadByGivingInvalidInputToAnnualRevenueTest () throws Throwable
	{
	//Step 1: Create Random numbers
			...
			String Avenue = cel2 .getStringCellValue();
			 //int Avenue = (int) Avenue1;
